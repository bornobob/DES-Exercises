...
def create_runner():
	...
	mission_Mission = Mission([BorderAction(priority=4), ColorDetAction(colors=[ColorSensor.COLOR_RED], priority=3), DontDrownAction(lakes=[ColorSensor.COLOR_RED, ColorSensor.COLOR_YELLOW, ColorSensor.COLOR_BLUE], priority=2), UltrasoundAction(rotate_degrees=0.5, dodge_rocks=False, priority=1)])
